...
function ReduxBasic({id}: Props) {
  ...
  function handleAddAmount() {
    dispatch(countersSlice.actions.incrementByAmount({ id, amount: inputValue }));
  }
  ...
  return (
    <div className="m-4 text-center bg-white p-2 rounded shadow">
      ...
      <div className="flex justify-around gap-2 mt-2">
        <button
          onClick={() => dispatch(countersSlice.actions.increment(id))}
        ...
        <button
          onClick={() => dispatch(countersSlice.actions.decrement(id))}
        ...
        <button
          onClick={() => dispatch(countersSlice.actions.reset(id))}
          type="button"
